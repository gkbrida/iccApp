                                    ...
                                    Padding(
                                      ...
                                      child: StreamBuilder<List<ChurchsRecord>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<ChurchsRecord>
                                              churchChurchsRecordList =
                                              snapshot.data!;

                                          return FlutterFlowDropDown<String>(
                                            controller:
                                                _model.churchValueController ??=
                                                    FormFieldController<String>(
                                                        null),
                                            options: churchChurchsRecordList
                                                .map((e) => e.name)
                                                .toList(),
                                            onChanged: (val) => safeSetState(
                                                () => _model.churchValue = val),
                                            width: double.infinity,
                                            height: 50.0,
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          context.pushNamed('validatedCand');
                                        },
                                        text: 'Valider',
