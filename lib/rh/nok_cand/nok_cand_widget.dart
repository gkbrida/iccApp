...
import 'nok_cand_model.dart';
export 'nok_cand_model.dart';

class NokCandWidget extends StatefulWidget {
  const NokCandWidget({
    super.key,
  ...
  @override
  State<NokCandWidget> createState() => _NokCandWidgetState();
}

class _NokCandWidgetState extends State<NokCandWidget> {
  late NokCandModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NokCandModel());
