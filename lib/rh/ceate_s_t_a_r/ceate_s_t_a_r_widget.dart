...
import 'ceate_s_t_a_r_model.dart';
export 'ceate_s_t_a_r_model.dart';

class CeateSTARWidget extends StatefulWidget {
  const CeateSTARWidget({
    super.key,
    bool? isAdmin,
    this.dptName,
  ...
  @override
  State<CeateSTARWidget> createState() => _CeateSTARWidgetState();
}

class _CeateSTARWidgetState extends State<CeateSTARWidget> {
  late CeateSTARModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CeateSTARModel());
                                        ...
                                        onPressed: () async {
                                          ...
                                          await applicationsRecordReference
                                            ...
                                            ...createApplicationsRecordData(
                                              ...
                                              department: widget.isAdmin
                                                  ? widget.dptName
                                                  : _model.currentDptName,
                                              statut: 'new',
                                              church: FFAppState().myChurchName,
                                              birthdate: _model.datePicked,
                                              createBy: currentUserReference,
                                            ),
                                            ...mapToFirestore(
                                              {
                                                'create_date': FieldValue
                                                    .serverTimestamp(),
                                              },
                                            ),
                                          });
                                          ...
                                          await _model.createdStar!.reference
                                              .update(
                                                  createApplicationsRecordData(
                                            id: _model.createdStar?.reference,
                                          ));
                                          context.safePop();
