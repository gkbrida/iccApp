...
import '/rh/affect_manager/affect_manager_widget.dart';
import '/rh/affect_manager_second/affect_manager_second_widget.dart';
...
class DepartmentsWidget extends StatefulWidget {
  ...
  final DepartmentsRecord? departement;
                    ...
                    StreamBuilder<List<ServicesRecord>>(
                      stream: queryServicesRecord(
                        queryBuilder: (servicesRecord) => servicesRecord
                            .where(
                              'Department',
                              isEqualTo: widget.departement?.reference,
                            )
                            .where(
                              'deleted',
                              isEqualTo: false,
                                                                ...
                                                                builder:
                                                                  ...
                                                                  return AlertDialog(
                                                                    title: const Text(
                                                                        'Suppression'),
                                                                    content: Text(
                                                                        'Êtes vous sûre de supprimer ${listViewServicesRecord.starName} du département ${listViewServicesRecord.departmentName} ?'),
                                                                    actions: [
                                                                      TextButton(
                      ...
                      children: [
                                ...
                                children: [
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          widget.departement!.ministryName,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
                                                fontFamily: 'Poppins',
                                ...
                                children: [
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          widget.departement!.managerName,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
                                                fontFamily: 'Poppins',
                                        ...
                                        builder: (context) {
                                          return GestureDetector(
                                            ...
                                            child: Padding(
                                              padding: MediaQuery.viewInsetsOf(
                                                  context),
                                              child: AffectManagerSecondWidget(
                                                department:
                                                    widget.departement!,
                                              ),
                                            ),
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              await widget.departement!.reference.delete();
                            },
                            child: Text(
                              'Supprimer ',
                              style: FlutterFlowTheme.of(context)
