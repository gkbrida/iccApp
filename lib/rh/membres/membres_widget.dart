...
class MembresWidget extends StatefulWidget {
  ...
  final List<ApplicationsRecord>? stars;
              ...
              Expanded(
                child: TabBarView(
                  ...
                  children: [
                    Builder(
                      builder: (context) {
                        final stars = widget.stars!.toList();
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, starsIndex) {
                            final starsItem = stars[starsIndex];
                            return Padding(
                    ...
                    Column(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        StreamBuilder<List<MinistriesRecord>>(
                          stream: queryMinistriesRecord(
                            queryBuilder: (ministriesRecord) =>
                                ministriesRecord.where(
                              'church',
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<MinistriesRecord>
                                listViewMinistriesRecordList = snapshot.data!;
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        'Ministry',
                                        queryParameters: {
                                          'minister': serializeParam(
                                            listViewMinistriesRecord,
                                            ParamType.Document,
                                          ),
                                        }.withoutNulls,
                                        extra: <String, dynamic>{
                                          'minister': listViewMinistriesRecord,
                                        },
                                      );
                                    },
                                    child: Container(
