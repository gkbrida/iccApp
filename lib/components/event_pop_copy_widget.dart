...
import 'event_pop_copy_model.dart';
export 'event_pop_copy_model.dart';

class EventPopCopyWidget extends StatefulWidget {
  const EventPopCopyWidget({
    super.key,
    required this.event,
  });
  ...
  @override
  State<EventPopCopyWidget> createState() => _EventPopCopyWidgetState();
}

class _EventPopCopyWidgetState extends State<EventPopCopyWidget> {
  late EventPopCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventPopCopyModel());
