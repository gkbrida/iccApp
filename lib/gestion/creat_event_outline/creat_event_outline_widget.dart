...
import 'creat_event_outline_model.dart';
export 'creat_event_outline_model.dart';

class CreatEventOutlineWidget extends StatefulWidget {
  const CreatEventOutlineWidget({
    super.key,
    required this.event,
  });
  ...
  @override
  State<CreatEventOutlineWidget> createState() =>
      _CreatEventOutlineWidgetState();
}

class _CreatEventOutlineWidgetState extends State<CreatEventOutlineWidget> {
  late CreatEventOutlineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatEventOutlineModel());
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            await OutlinesRecord.collection.doc().set({
                              ...createOutlinesRecordData(
                                ...
                                lastTaskDate: _model.datePicked1,
                              ),
                              ...mapToFirestore(
                                {
