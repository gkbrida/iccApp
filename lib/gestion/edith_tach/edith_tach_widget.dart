...
import 'edith_tach_model.dart';
export 'edith_tach_model.dart';

class EdithTachWidget extends StatefulWidget {
  const EdithTachWidget({
    super.key,
  ...
  final List<StakeholdersRecord>? stake;

  @override
  State<EdithTachWidget> createState() => _EdithTachWidgetState();
}

class _EdithTachWidgetState extends State<EdithTachWidget> {
  late EdithTachModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EdithTachModel());
    ...
    _model.dureeTextController ??=
        TextEditingController(text: widget.task?.duree.toString());
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Builder(
                              builder: (context) {
                                final intervenantItem = widget.stake!.toList();

                                return Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children:
                                      List.generate(intervenantItem.length,
                                          (intervenantItemIndex) {
                                    final intervenantItemItem =
                                        intervenantItem[intervenantItemIndex];
                                    return Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            () {
                                              if (intervenantItemItem
                                                      .typeStakeholder ==
                                                  '0') {
                                                return intervenantItemItem
                                                    .dptName;
                                              } else if (intervenantItemItem
                                                      .typeStakeholder ==
                                                  '1') {
                                                return intervenantItemItem
                                                    .starName;
