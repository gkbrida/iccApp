...
import 'post_event_model.dart';
export 'post_event_model.dart';
...
class PostEventWidget extends StatefulWidget {
  ...
  @override
  State<PostEventWidget> createState() => _PostEventWidgetState();
}

class _PostEventWidgetState extends State<PostEventWidget> {
  late PostEventModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostEventModel());
