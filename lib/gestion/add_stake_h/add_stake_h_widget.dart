...
import 'add_stake_h_model.dart';
export 'add_stake_h_model.dart';

class AddStakeHWidget extends StatefulWidget {
  const AddStakeHWidget({
    super.key,
  ...
  @override
  State<AddStakeHWidget> createState() => _AddStakeHWidgetState();
}

class _AddStakeHWidgetState extends State<AddStakeHWidget> {
  late AddStakeHModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddStakeHModel());
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            var eventTasksRecordReference =
                                EventTasksRecord.collection.doc();
                            await eventTasksRecordReference.set({
                              ...createEventTasksRecordData(
                            ...
                            _model.currentTask =
                                EventTasksRecord.getDocumentFromData({
                              ...createEventTasksRecordData(
                                description: widget.description,
                                createdBy: currentUserDocument?.candidate,
                                session: widget.session?.reference,
