...
import 'new_interaction_model.dart';
export 'new_interaction_model.dart';

class NewInteractionWidget extends StatefulWidget {
  const NewInteractionWidget({
    super.key,
  ...
  @override
  State<NewInteractionWidget> createState() => _NewInteractionWidgetState();
}

class _NewInteractionWidgetState extends State<NewInteractionWidget> {
  late NewInteractionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewInteractionModel());
                    ...
                    children: [
                      Padding(
                        ...
                        child: FlutterFlowDropDown<String>(
                          controller: _model.interactionValueController ??=
                              FormFieldController<String>(null),
                          options: const ['Téléphonique', 'Présentielle', 'Visio'],
                          onChanged: (val) =>
                              safeSetState(() => _model.interactionValue = val),
                          width: double.infinity,
                          height: 50.0,
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await InteractionsRecord.collection.doc().set({
                              ...createInteractionsRecordData(
                                cantactDate: _model.datePicked,
                                contactType: _model.interactionValue,
