...
import '/integration/add_new_member/add_new_member_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_spinkit/flutter_spinkit.dart';
import 'package:provider/provider.dart';
import 'integration_c_frespo_model.dart';
export 'integration_c_frespo_model.dart';

class IntegrationCFrespoWidget extends StatefulWidget {
  const IntegrationCFrespoWidget({
    super.key,
    required this.dptID,
    this.advisor,
  });
  ...
  final GroupAdvisorRecord? advisor;

  @override
  State<IntegrationCFrespoWidget> createState() =>
      _IntegrationCFrespoWidgetState();
}

class _IntegrationCFrespoWidgetState extends State<IntegrationCFrespoWidget> {
  late IntegrationCFrespoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IntegrationCFrespoModel());
            ...
            child: StreamBuilder<List<NewcomersRecord>>(
              stream: queryNewcomersRecord(
                queryBuilder: (newcomersRecord) => newcomersRecord
                    ...
                    .where(
                      'advisor',
                      isEqualTo: widget.advisor?.advisor,
                    ),
              ),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (!listViewNewcomersRecord.affect)
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        4.0, 0.0, 4.0, 4.0),
                                    child: Row(
