...
import 'set_tracking_model.dart';
export 'set_tracking_model.dart';
...
class SetTrackingWidget extends StatefulWidget {
  ...
  final TrackingsRecord? infoTrackibng;
...
class _SetTrackingWidgetState extends State<SetTrackingWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SetTrackingModel());

    _model.fiValue = widget.infoTrackibng!.hasFi;
    _model.startdateTextController ??= TextEditingController();
    _model.startdateFocusNode ??= FocusNode();

    _model.baptisValue = widget.infoTrackibng!.baptism;
    _model.enddateTextController1 ??= TextEditingController();
    _model.enddateFocusNode1 ??= FocusNode();

    _model.starValue = widget.infoTrackibng!.hisStar;
    _model.enddateTextController2 ??= TextEditingController();
    _model.enddateFocusNode2 ??= FocusNode();

    _model.commentTextController ??=
        TextEditingController(text: widget.infoTrackibng?.comments);
    _model.commentFocusNode ??= FocusNode();

    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.startdateTextController?.text = dateTimeFormat(
            "d/M/y",
            widget.infoTrackibng?.fiDate,
            locale: FFLocalizations.of(context).languageCode,
          );
          _model.enddateTextController1?.text = dateTimeFormat(
            "d/M/y",
            widget.infoTrackibng?.baptismDate,
            locale: FFLocalizations.of(context).languageCode,
          );
          _model.enddateTextController2?.text = dateTimeFormat(
            "d/M/y",
            widget.infoTrackibng?.starDate,
            locale: FFLocalizations.of(context).languageCode,
          );
        }));
  }
                    ...
                    children: [
                            ...
                            builder: (context, snapshot) {
                              ...
                              return FlutterFlowDropDown<String>(
                                controller: _model.finameValueController ??=
                                  ...
                                  _model.finameValue ??=
                                      widget.infoTrackibng?.impactFamilly,
                                ),
                              ...
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  final datePicked1Date = await showDatePicker(
                                    ...
                                    lastDate: (widget.infoTrackibng?.fiDate ??
                                        DateTime.now()),
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await widget.infoTrackibng!.reference.update({
                              ...
                              ...mapToFirestore(
                                {
                                  'last_modif': FieldValue.serverTimestamp(),
                                },
                              ),
                            });
