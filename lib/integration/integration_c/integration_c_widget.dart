...
import 'integration_c_model.dart';
export 'integration_c_model.dart';

class IntegrationCWidget extends StatefulWidget {
  const IntegrationCWidget({
    super.key,
    required this.dptID,
  });
  ...
  @override
  State<IntegrationCWidget> createState() => _IntegrationCWidgetState();
}

class _IntegrationCWidgetState extends State<IntegrationCWidget> {
  late IntegrationCModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IntegrationCModel());
        ...
        body: SafeArea(
          ...
          child: Padding(
            ...
            child: AuthUserStreamWidget(
              builder: (context) => StreamBuilder<List<NewcomersRecord>>(
